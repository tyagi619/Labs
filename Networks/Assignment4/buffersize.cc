...
MyApp::MyApp()
    : m_socket(0), m_peer(), m_pktSize(0), m_nPackets(0), m_dataRate(0), m_sendEvent(), m_running(false), m_packetsSent(0) {}
...
int main(int argc, char* argv[]) {
    ...
    for (bufferSize = 10 * pktSize; bufferSize <= 800 * pktSize;) {
        ...
        double sumFlow = 0, sumFlowSquare = 0, sumFlowTCP = 0;
        ...
        dataset.Add(bufferSize / pktSize, FairnessIndex);
        datasetTcp.Add(bufferSize / pktSize, sumFlowTCP);
        datasetUdp.Add(bufferSize / pktSize, sumFlow - sumFlowTCP);
    ...
    std ::string fileNameWithNoExtension = "buffersizefairness";
    std ::string graphicsFileName = fileNameWithNoExtension + ".png";
    std ::string plotFileName = fileNameWithNoExtension + ".plt";
    std ::string plotTitle = "Buffer Size vs Fairness plot";

    std ::string fileNameWithNoExtensionTcp = "buffersize_tcp";
    std ::string graphicsFileNameTcp = fileNameWithNoExtensionTcp + ".png";
    std ::string plotFileNameTcp = fileNameWithNoExtensionTcp + ".plt";
    std ::string plotTitleTcp = "Buffer Size vs Throughput(TCP)";

    std ::string fileNameWithNoExtensionUdp = "buffersize_udp";
    std ::string graphicsFileNameUdp = fileNameWithNoExtensionUdp + ".png";
    std ::string plotFileNameUdp = fileNameWithNoExtensionUdp + ".plt";
    std ::string plotTitleUdp = "Buffer Size vs Throughput(UDP)";
    ...
    plot_tcp.SetLegend("Buffer Size(packets)", "Throughput(in mbps)");
    plot_udp.SetLegend("Buffer Size(packets)", "Throughput(in mbps)");

    // Set the x value ranges for each plots
    plot.AppendExtra("set xrange [0:800]");
    plot_tcp.AppendExtra("set xrange [0:800]");
    plot_udp.AppendExtra("set xrange [0:800]");
